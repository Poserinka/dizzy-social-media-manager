...
final class PosterSettings
{
    ...
    public function registerSettings(): void
    {
        ...
        foreach (['title_align', 'date_align'] as $key) {
        ...
        <div class="wrap dizzy-poster-layout-settings">
            ...
            <form method="post" action="<?php echo esc_url(admin_url('options.php')); ?>">
                ...
                <table class="form-table">
                    ...
                    <?php endforeach; ?>
                    <?php foreach (['title' => __('Title alignment', 'dizzy-social-media-manager'), 'date' => __('Date alignment', 'dizzy-social-media-manager')] as $key => $label) : ?>
