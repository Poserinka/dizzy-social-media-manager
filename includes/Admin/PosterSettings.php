...
final class PosterSettings
{
    ...
    public function renderPage(): void
    {
        ...
        <style>
        #dizzy-layout-stage{position:relative;width:min(600px,100%);aspect-ratio:4/5;overflow:hidden;background:linear-gradient(135deg,#343840,#101114);border:2px solid #8c8f94;touch-action:none;outline:none}#dizzy-layout-stage:focus{border-color:#2271b1;box-shadow:0 0 0 1px #2271b1}#dizzy-layer-preview{position:absolute;inset:0;width:100%;height:100%;object-fit:fill;pointer-events:none}#dizzy-layer-preview:not([src]){display:none}.dizzy-layout-item{position:absolute;color:#fff;font-weight:700;cursor:move;user-select:none;border:0;padding:0;line-height:1;white-space:nowrap;text-shadow:0 1px 3px #000;transform-origin:top left}.dizzy-layout-item.is-selected{outline:1px dashed #72aee6;background:rgba(34,113,177,.2)}.dizzy-layout-item[data-item=title]{font-size:38px}.dizzy-layout-item[data-item=date],.dizzy-layout-item[data-item=hours]{font-size:16px}.dizzy-logo-item{width:25%;padding:0}.dizzy-logo-item img{display:block;width:100%;height:auto}.dizzy-logo-item img:not([src]){min-height:50px;background:rgba(255,255,255,.2)}.dizzy-resize-handle{display:none;position:absolute;right:-6px;bottom:-6px;width:12px;height:12px;background:#2271b1;border:1px solid #fff;cursor:nwse-resize}.is-selected .dizzy-resize-handle{display:block}.dizzy-layout-tools{margin-bottom:10px}
